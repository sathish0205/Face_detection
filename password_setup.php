...
if(isset($_POST['submit'])){
    ...
    if($_GET['empl_email']){
        $encoded_email = $_GET['empl_email'];
        $empl_email = base64_decode($encoded_email);
    ...
    $escaped_email = mysqli_real_escape_string($conn, $empl_email);
    $sql = "UPDATE employeesusers SET password = '$escaped_password' WHERE empl_email = '$empl_email'";
...
if(isset($_GET['empl_email'])){
    ...
    $sql23 = "SELECT * FROM employeesusers WHERE empl_email = '$empl_email'";
    ...
    <div class="col-lg-6 d-flex justify-content-center">
        <div class="Wrapper p-5" style="margin-top: 12%;">
            <form id="loginForm" class="p-5" method="POST">
                ...
                <input type="hidden" name="email" id="email" value="<?php echo htmlspecialchars($empl_email); ?>" required>
                <div id="message"></div>
...
?>
    ...
    $(document).ready(function() {
        ...
        var empl_email = urlParams.get('empl_email');

        $('#email').val(empl_email); 
